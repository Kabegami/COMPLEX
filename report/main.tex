		...
		\end{figure}
		  ...
		  \end{figure}
                ...
                \paragraph{Conclusion}{
                  Le choix des bornes est une étape crucial car ce sont elles qui nous permettent d'avoir un algorithme efficace mais c'est aussi difficile car il y a un compromis à faire entre le temps de calcul de la borne et sa qualité ( le nombre de noeud qu'elle permet d'élaguer).
