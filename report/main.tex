...
\begin{document}
	...
	\section*{Partie 3: Mise en oeuvre}
		...
		Pour vérifier que nos algorithmes approchés retournent le bon résultat on trace leur resultat et 2*opt pour tous les types de donnés (figure~\ref{fig:validiteJ}).
